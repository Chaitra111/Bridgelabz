...
public class AddressBookAppl {
	public static void main(String[] args)throws JsonGenerationException, JsonMappingException, IOException, ParseException {
		AddressBookManager controller = new AddressBookManager();
		...
		System.out.println("5: DELETE THE ADDRESSBOOK");
		System.out.println("6: EXIT THE ADDRESSBOOK");
		int choice = 0;
		while (choice < 7) {
			...
			case 4:
				...
				while (input < 8) {
					System.out.println("enter your choice to do which operation");
					input = Utility.getInteger();

					switch (input) {
					case 1:
						controller.doAdd(file);
						break;
					case 2:
						System.out.println("Enter index to edit");
						int index = Utility.getInteger();
						controller.doEdit(index, file);
						break;
					case 3:
						System.out.println("Enter index to delete");
						int indexD = Utility.getInteger();
			...
			case 5:
				controller.doView();
				String filedelete = controller.findFile();
				System.out.println("Delete the address book");
				controller.doDeleteAddressBook(filedelete);
				break;
			case 6:
